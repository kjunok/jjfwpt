...
import com.jjkj.support.pay.WxPay;
import com.jjkj.support.pay.WxPayment;
...
public final class WeChatUtil {
    ...
    /**
     * 下单
     * @param trade_type 交易类型(APP/MWEB/JSAPI/NATIVE)
     * @param out_trade_no 商户订单号
     * @param body 商品描述
     * @param detail 商品详细描述
     * @param amount 交易金额
    ...
    public static RefundResult refund(String transaction_id, String out_trade_no, String out_refund_no,
        ...
        try {
            ...
            //TODO
            String path ="";//resolver.getResources(PropertiesUtil.getString("wx.certPath")).getFile().getAbsolutePath();
    ...
    public static PayResult micropay(String device_info, String body, String detail, String attach, String out_trade_no,
        BigDecimal total_fee, String spbill_create_ip, String auth_code) {
