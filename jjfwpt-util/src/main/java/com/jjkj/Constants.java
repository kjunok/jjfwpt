...
import com.jjkj.support.cache.CacheKey;
 ...
 *
 * @author WangJun
 * @version $Id: Constants.java, v 0.1 2014-2-28 上午11:18:28 WangJun Exp $
 */
public interface Constants {
     ...
     * 非常遗憾的通知您,程序发生了异常
     */
    static final String EXCEPTION_HEAD = "程序异常:";
    /** 缓存键值 */
    ...
    /** 缓存命名空间 */
    static final String CACHE_NAMESPACE = "JJKJ:";
    /** 缓存命名空间 */
    static final String SYSTEM_CACHE_NAMESPACE = "S:JJKJ:";
    /** 缓存命名空间 */
    static final String CACHE_NAMESPACE_LOCK = "L:JJKJ:";
    /** 上次请求地址 */
    ...
    /** CACHE */
    static final String MYBATIS_CACHE = "D:JJKJ:MYBATIS:";
    /** 默认数据库密码加密key */
    static final String DB_KEY = "90139119";
    /** 临时目录 */
    static final String TEMP_DIR = "/temp/";
    /** 请求报文体 */
    static final String REQUEST_BODY = "JJKJ.requestBody";
