 ...
 * @Description:
 */
public class JJKJRefreshTokenGranter extends RefreshTokenGranter {
    private int refreshTokenValiditySeconds = 2592000;
    private TokenStore tokenStore;
    private boolean reuseRefreshToken;

    public JJKJRefreshTokenGranter(boolean reuseRefreshToken, TokenStore tokenStore, AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory) {
